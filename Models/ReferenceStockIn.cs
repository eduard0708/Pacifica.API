...
{
    public class ReferenceStockIn : AuditDetails
    {
        public int Id { get; set; }  // Primary key
        public string ReferenceStockInName { get; set; } = string.Empty;  // Name of the transaction (e.g., Received, Sold, Transferred)
