            ...
            try
            {
                foreach (var branchProduct in branchProducts)
                {
                    ...
                    var auditTrail = new BranchProductAuditTrail
                    {
                        ...
                        NewValue = $"{{ \"CostPrice\": {branchProduct.CostPrice}, \"RetailPrice\": {branchProduct.RetailPrice}, \"StockQuantity\": {branchProduct.StockQuantity} }}",
                        Remarks = "Product added to branch"
                    };
