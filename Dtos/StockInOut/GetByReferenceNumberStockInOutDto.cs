namespace Pacifica.API.Dtos.StockInOut
{
    public class GetByReferenceNumberStockInOutDto
    {
        ...
        public string? ReferenceStockInName { get; set; }  // For the transaction reference name
        public int ReferenceStockOutId { get; set; }
        public string? ReferenceStockOutName { get; set; }  // For the transaction reference name
