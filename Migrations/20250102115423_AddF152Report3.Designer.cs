...
namespace Pacifica.API.Migrations
{
    ...
    [Migration("20250102115423_AddF152Report3")]
    partial class AddF152Report3
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Pacifica.API.Models.Inventory.BeginningInventory", b =>
                {
                    ...
                    b.Property<string>("AgriculturalFeedsColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AgriculturalFeedsIcon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AgriculturalFeedsName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("AgriculturalFeedsValue")
                        .HasColumnType("decimal(18,2)");

                    b.Property<DateTime>("BeginningInventoryDate")
                        .HasColumnType("datetime2");

                    b.Property<int?>("BranchId")
                        .HasColumnType("int");

                    b.Property<string>("ChemicalsOthersColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ChemicalsOthersIcon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ChemicalsOthersName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("ChemicalsOthersValue")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("DayOldChicksColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DayOldChicksIcon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DayOldChicksName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("DayOldChicksValue")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("FertilizersSeedsColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FertilizersSeedsIcon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FertilizersSeedsName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("FertilizersSeedsValue")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("SpecialtyFeedsColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SpecialtyFeedsIcon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SpecialtyFeedsName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("SpecialtyFeedsValue")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("VeterinaryColor")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("VeterinaryIcon")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<decimal>("VeterinaryValue")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("Pacifica.API.Models.Reports.F152Report.F152ReportCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("AdjustmentRetail")
                        .HasColumnType("decimal(18,2)");

                    b.Property<string>("Category")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("CostWeek1")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CostWeek2")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CostWeek3")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("CostWeek4")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<int>("F152ReportTransactionId")
                        .HasColumnType("int");
                    ...
                    b.Property<decimal>("RetailWeek1")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("RetailWeek2")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("RetailWeek3")
                        .HasColumnType("decimal(18,2)");

                    b.Property<decimal>("RetailWeek4")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.HasIndex("F152ReportTransactionId");

                    b.ToTable("F152ReportCategories", (string)null);
                });

            modelBuilder.Entity("Pacifica.API.Models.Reports.F152Report.F152ReportTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("F152ReportTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("Pacifica.API.Models.Reports.F152Report.F152ReportCategory", b =>
                {
                    b.HasOne("Pacifica.API.Models.Reports.F152Report.F152ReportTransaction", "F152ReportTransaction")
                        .WithMany("F152ReportCategories")
                        .HasForeignKey("F152ReportTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("F152ReportTransaction");
                });

            modelBuilder.Entity("Pacifica.API.Models.Reports.F152Report.F152ReportTransaction", b =>
                {
                    b.HasOne("Pacifica.API.Models.Branch", "Branch")
                        .WithMany("F152ReportTransactions")
                        .HasForeignKey("BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Pacifica.API.Models.Branch", b =>
                {
                    ...
                    b.Navigation("F152ReportTransactions");
            ...
            modelBuilder.Entity("Pacifica.API.Models.Reports.F152Report.F152ReportTransaction", b =>
                {
                    b.Navigation("F152ReportCategories");
                });
