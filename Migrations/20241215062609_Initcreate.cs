        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockQuantity = table.Column<decimal>(type: "decimal(7,1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WeeklyInventories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WeeklyInventories_BranchProducts_BranchId_ProductId",
                        columns: x => new { x.BranchId, x.ProductId },
                        principalTable: "BranchProducts",
                        principalColumns: new[] { "BranchId", "ProductId" },
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockOuAuditTrails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockOuAuditTrails_StockOuts_StockOutId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockOuAuditTrails_StockOutId",
                table: "StockOuAuditTrails",
                column: "StockOutId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WeeklyInventories_BranchId_ProductId",
